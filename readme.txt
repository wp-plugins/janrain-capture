...
Activating Capture 2.0:
  ...
  2.  Navigate to Dashboard > Janrain Capture.
  3.  A new UI Type field has been added. Change the UI Type to Capture 2.0 and click save.
  4.  Capture 2.0 settings are configured in the 2.0 Settings and UI Settings tabs. Any existing Capture 1.0 settings will be preserved and hidden until you change the UI Type back. 
